...
class InterviewQuestionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'old_answers.*' => 'nullable|string|min:3|max:255',
            'new_answers'   => 'nullable|array',
            'new_answers.*' => 'nullable|string|min:3|max:255',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'old_answers.*.min' => 'Вариант ответа должен быть не меньше 3 символов',
            'old_answers.*.max' => 'Вариант ответа должен быть не больше 255 символов',
            'new_answers.*.min' => 'Вариант ответа должен быть не меньше 3 символов',
