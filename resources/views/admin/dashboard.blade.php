        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-light-blue-gradient">
                    ...
                    <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> {{--TODO: Add URL to Gosu Replay--}}
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-teal-gradient">
                    ...
                    <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> {{--TODO: Add URL to User Replay--}}
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-purple-gradient">
                    ...
                    <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>{{--TODO: Add URL to Users--}}
                </div>
            </div>
            <!-- ./col -->
        </div>
