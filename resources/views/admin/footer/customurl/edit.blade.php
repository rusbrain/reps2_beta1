...
@section('page_header')
    Подвал сайта: Создание нового URL  - {{$footer_url->title}}
@endsection

@section('breadcrumb')
    <li><a href="{{route('admin.home')}}"><i class="fa fa-dashboard"></i>Главная панель</a></li>
    <li><a href="{{route('admin.footer.customurl')}}">Подвал/Футер сайта</a></li>
    <li class="active">Пользовательский URL: {{$footer_url->title}}</li>
@endsection
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title text-blue">{{$footer_url->title}}</h3>
            </div>
            <div class="box-body">
                <div class="box-tools col-md-12">
                    <div class="post">
                        <form method="post" action="{{route('admin.footer.customurl.update',['id' => $footer_url->id])}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Название..."
                                           value="{{old('title')??$footer_url->title}}">
                                    @if ($errors->has('title'))
                                        ...
                                        <div class="box-header">
                                            <h3 class="box-title">Подтвердить
                                                <input type="checkbox" name="approved" class="flat-red"
                                                       {{old('approved')?'checked':($footer_url->approved?'checked':'')}} value="1">
