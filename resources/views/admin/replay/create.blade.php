                        ...
                        <form method="post" enctype="multipart/form-data" action="{{route('admin.replay.create')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="game_version" class="form-control" placeholder="Локация..." value="{{old('game_version')}}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="championship" class="form-control" placeholder="Локация..." value="{{old('championship')}}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="evaluation" class="form-control" placeholder="Локация..." value="{{old('evaluation')}}">
