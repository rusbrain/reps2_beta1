                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="first_name" class="form-control"
                                                       placeholder="Имя..." value="{{old('first_name')}}" id="first_name">
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="first_apm" class="form-control"
                                                       placeholder="APM..." value="{{old('first_apm')}}" id="first_apm">
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="second_name" class="form-control"
                                                       placeholder="Имя..." value="{{old('second_name')}}" id="second_name">
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="second_apm" class="form-control"
                                                       placeholder="APM..." value="{{old('second_apm')}}" id="second_apm">
                                            </div>
