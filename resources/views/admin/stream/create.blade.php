...
@section('breadcrumb')
    ...
    <li><a href="{{route('admin.stream')}}">Stream</a></li>
    <li class="active">Создать новый Stream</li>
@endsection
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title text-blue">Создать новый Stream</h3>
            </div>
            <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="race">
                                            @foreach(\App\Stream::$races as $race)
                                                <option value="{{$race}}" {{$race == old('race')?'selected':''}}>{{$race}}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('race'))
                                            <span class="invalid-feedback text-red" role="alert">
                                ...
                                <div class="col-md-6">
                                    <div class="box-body pad">
                                        ...
                                        <textarea name="stream_url"
                                                  ...
                                                  id="stream_url"
                                                  rows="10">{!! old('stream_url') !!}</textarea>
