    ...
    <div class="row">
        <div class="col-md-12">
            <div class="content-center">
                <div class="page-title w-100">Редактирование поста {!! $topic->title !!}</div>
                <div class="edit-topic-form">
                    <form method="post" action="{{route('forum.topic.update',['id' => $topic->id])}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <select class="form-control" id="section_id" name="section_id">
                                        @foreach($sections as $section)
                                            <option value="{{$section->id}}"
                                                    {{$section->id == $topic->section_id?'selected':''}}>
                                                {{$section->title}}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <img class="img-responsive"
                                     src="{{route('home').($topic->preview_image->link??'/dist/img/default-50x50.gif')}}"
                                     alt="Photo">
                                <br>
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="preview_content"
                                              ...
                                              rows="5">{!! old('preview_content')??$topic->preview_content !!}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="date" name="start_on" class="form-control pull-right"
                                               id="datepicker" value="{{old('start_on')??($topic->start_on??'')}}">
