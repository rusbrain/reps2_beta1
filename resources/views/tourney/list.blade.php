...
@section('content')
    ...
    <div class="content-box">
        ...
        <!--  TOURNAMENTS LIST -->
        <div id="ajax_section_tournaments_list" data-path="{{route('tournament.paginate').'?'.$request}}">        
            <div class="load-wrapp">
                <img src="/images/loader.gif" alt="">
            </div>
        </div>
        <!-- END TOURNAMENTS LIST -->
...
@section('js')
    <script>
        ...
        function getSections(page) {
            var container = $('#ajax_section_tournaments_list');
            var path = container.attr('data-path');
            var body = $("html, body");

            $.get(path + '&page=' + page, {}, function (data) {
                container.html(data.tournaments);
