...
Route::group(['middleware' => ['auth', 'admin_panel'], 'prefix' => 'admin_panel', 'namespace' => 'Admin'], function () {
    ...
    Route::group(['prefix' => 'forum'], function (){
        ...
        Route::group(['prefix' => 'topic'], function (){
            Route::get('/', 'ForumController@topics')                               ->name('admin.forum_topic');
            Route::get('/{id}/news', 'ForumController@news')                        ->name('admin.forum.topic.news');
            Route::get('/{id}/not_news', 'ForumController@notNews')                 ->name('admin.forum.topic.not_news');
